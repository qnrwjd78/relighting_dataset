...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Download Poly Haven HDRIs and write metadata manifests."
    )
    ...
    parser.add_argument("--manifest", default="metadata/polyhaven_hdri/polyhaven_hdri_hdris.txt")
    parser.add_argument("--metadata-out", default="metadata/polyhaven_hdri/polyhaven_hdri_index.json")
