...
DEFAULT_METADATA_ROOT = REPO_ROOT / "metadata" / "polyhaven_hdri"
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--manifest", default=str(DEFAULT_METADATA_ROOT / "polyhaven_hdri_hdris.txt"))
    ...
    parser.add_argument("--index-out", default=str(DEFAULT_METADATA_ROOT / "polyhaven_hdri_index.json"))
