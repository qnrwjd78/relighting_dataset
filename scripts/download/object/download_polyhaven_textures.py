...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Download Poly Haven PBR textures and write a metadata manifest."
    )
    ...
    parser.add_argument("--metadata-out", default="metadata/polyhaven_textures/polyhaven_textures.json")
