...
DEFAULT_METADATA_ROOT = REPO_ROOT / "metadata" / "polyhaven_textures"
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--metadata", default=str(DEFAULT_METADATA_ROOT / "polyhaven_textures.json"))
    ...
    parser.add_argument("--index-out", default=str(DEFAULT_METADATA_ROOT / "polyhaven_textures_index.json"))
