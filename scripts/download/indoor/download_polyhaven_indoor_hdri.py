...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Download indoor/studio Poly Haven HDRIs for indoor relighting scenes.")
    parser.add_argument("--categories", nargs="+", default=["indoor", "studio"])
...
def main() -> int:
    ...
    cmd = [
        sys.executable,
        str(ROOT / "scripts" / "download" / "hdri" / "download_polyhaven_hdri.py"),
        "--categories",
        *args.categories,
        "--per-category",
